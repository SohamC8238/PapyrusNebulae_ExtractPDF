...
This function segregates the information present in the invoice into five
categories namely business details, invoice details, customer details and
bill details. Data Segregation has been done in terms of bounds, path and
text.
...
Function Description: 
This function extracts useful data from the raw business details and then
segregates into name, address and description
...
Function Description: 
This function extracts useful data from the raw invoice details and then
segregates into invoice number, issue date, due date and description.
...
Function Description: 
This function extracts useful data from the raw customer details and then
segregates into name, address, email and phone number.
...
Function Description: 
This function uses table path and table id of the table with items to 
get their name rate and quantity.
...
Function Description: 
This function combines business details, invoice details, customer 
details, and bill details and stores them in rows to write into the csv
file. 
